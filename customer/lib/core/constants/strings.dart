...
class GlobalStrings {
  ...
  /// API
  /// prod
  static const String webUrl = ''; //'app.xtridelink.com';
  static const String host = 'xtridelink.online'; //'prod-api.xtridelink.com';
  static const String socketUrl = 'ws://xtridelink.online';

  /// staging
  // static const String webUrl = 'staging-app.xtridelink.com';
  // static const String host = 'staging-api.xtridelink.com';
  // static const String socketUrl = 'https://staging-realtime.xtridelink.com';

  /// dev
  // static const String webUrl = 'dev-app.xtridelink.com';
  // static const String host = 'dev-api.xtridelink.com';
  // static const String socketUrl = 'https://dev-realtime.xtridelink.com';
  ...
  static final List<Faq> faqs = [
    Faq(
        question: 'What is Xtridelink?',
        answer:
            '''Xtridelink is a logistics platform that connects logistics companies/riders with customers across Africa. Customers can place delivery requests through our web app, and logistics companies/riders can accept those requests and make the deliveries.
...
Our platform streamlines the entire logistics process, making it fast, easy, and convenient for both customers and logistics professionals.'''),
    Faq(
        question: 'Is Xtridelink available in my area?',
        answer:
            'We\'re constantly expanding our network to reach new customers and logistics professionals across Africa. To find out if Xtridelink is available in your area, simply visit the web app and check for available delivery options.'),
    Faq(
        question:
            'How can I trust that my deliveries will be handled safely and professionally?',
        answer:
            'At Xtridelink, we take safety and professionalism seriously. All of our logistics partners undergo rigorous training and background checks to ensure that they\'re equipped to handle deliveries safely and efficiently. Additionally, our web app provides real-time tracking and communication throughout the delivery process, so you can always stay informed about your delivery status.'),
    Faq(
        question: 'What types of deliveries can I make with Xtridelink?',
        answer:
            'Xtridelink is equipped to handle a wide range of delivery types, from food and retail deliveries to bulk goods and industrial equipment. Our logistics partners are equipped to handle deliveries of all sizes and types, ensuring that you can get the logistics support you need, no matter what you\'re delivering.'),
    Faq(
        question: 'How does Xtridelink compare to other logistics platforms?',
        answer:
            'Xtridelink is uniquely focused on the African market, providing tailored logistics solutions that are designed to meet the unique needs of businesses and customers across the continent. Our platform is fast, reliable, and efficient, with real-time tracking and communication tools that ensure you\'re always in the loop. Plus, our logistics partners are carefully vetted to ensure that they\'re equipped to handle deliveries safely and professionally. When it comes to logistics in Africa, Xtridelink is the clear choice.'),
    Faq(
        question: 'How do I know my package will be delivered on time?',
        answer:
            'Xtridelink works with a network of reliable and experienced logistics companies to ensure that your package is delivered on time. We also provide real-time tracking so you can monitor the progress of your delivery.'),
    Faq(
        question: 'Can I get a delivery quote before booking a shipment?',
        answer:
            'Yes, Xtridelink provides instant quotes for your shipment based on factors such as distance, weight, and type of package. You can easily compare prices from different logistics companies and choose the one that fits your budget.'),
    Faq(
        question: 'What if there\'s a problem with my delivery?',
        answer:
            'Xtridelink has a customer support team available 24/7 to assist with any issues that may arise during the delivery process. Our logistics partners are also trained to handle unexpected situations and will work to resolve any problems as quickly as possible.'),
    Faq(
        question: 'Can I schedule a delivery in advance?',
        answer:
            'Yes, with Xtridelink you can schedule a delivery for a future date and time that works best for you. This is particularly helpful for businesses that need to make regular deliveries or have specific delivery windows.'),
  ];
...
1.3.You may be required to register with XtrideLink in order to access and use certain features of the Service. If you choose to register for the Service, you agree to provide and maintain true, accurate, current and complete information about yourself as prompted by the Service registration form. You acknowledge and agree that your use of certain features of the Services requires current and accurate information about you, including your address and mobile phone number. XtrideLink is not responsible for any delays or inabilities to use the Services that result from your providing false, inaccurate, incomplete or out-of-date information. Registration data and certain other information about you are governed by our Privacy Policy. If you are under 18 years old, you may use the Service, with registering, only with the approval of your parent or guardian.

1.4.You are responsible for maintaining the confidentiality of your password and account, if any, and are fully responsible for any and all activities that occur under your password or account. You agree to (a) immediately notify XtrideLink of any unauthorized use of your password or account or any other breach of security, and (b) ensure that you exit from your account at the end of each session when accessing the Service. XtrideLink will not be liable for any loss or damage arising from your failure to comply with this Section.

1.5.In addition, when using certain services, you will be subject to any additional terms applicable to such services that may be posted on the Service from time to time, including, without limitation, the Privacy Policy located at https://XtrideLink.com/privacy-policy  and the FAQ Guide, which describes in detail how you may use the XtrideLink Services. All such terms are hereby incorporated by reference into this TOS.
    '''),
    Faq(
        question: '2. Description of Service',
        answer:
            '''2.1.XtrideLink is a technology company that does not directly provide delivery and moving services and the Company is not a transportation and delivery provider. It is up our logistics partners (the "Service Providers") you are registered to, to accept your delivery requests and it is up to you (references to "You", "Your" or "User" shall mean references to each visitor to the Website (as defined below), as the context requires) to accept their quotes/rates for your delivery (the "service provider"). The service of the Company is to link you with your service Provider/s (the "logistics partners") through the use of an application supplied by XtrideLink and downloaded and installed by you on your single mobile or tablet device (the "Application") or Web application but does not nor is it intended to provide delivery services or any act that can be construed in any way as an act of a Delivery Provider. The Company is not responsible or liable for the acts and/or omissions of any Delivery Provider and/or any delivery or shipping cargo provided to you.
'''),
    Faq(
        question: '3. Mobile Services',
        answer:
            '''3.1.The Service includes certain services that are available via a mobile device, including (i) the ability to upload content to the Service via a mobile device, (ii) the ability to browse the Service and the Site from a mobile device and (iii) the ability to access certain features through an application downloaded and installed on a mobile device (collectively, the Mobile Services). To the extent you access the Service through a mobile device, your wireless service carriers standard charges, data rates and other fees may apply. In addition, downloading, installing, or using certain Mobile Services may be prohibited or restricted by your carrier, and not all Mobile Services may work with all carriers or devices. By using the Mobile Services, you agree that we may communicate with you regarding XtrideLink and other entities by SMS, Phone call or other electronic means to your mobile device and that certain information about your usage of the Mobile Services may be communicated to us. You agree that as part of the registration process, XtrideLink may request that you verify your mobile device via SMS. In the event you change or deactivate your mobile telephone number, you agree to promptly update your XtrideLink account information to ensure that your messages are not sent to the person that acquires your old number
'''),
    Faq(
        question: '4. General Conditions/Use of the Service',
        answer:
            '''4.1.Subject to the terms and conditions of this TOS, you may access and use the Service only for lawful purposes. All rights, title and interest in and to the Service and its components will remain with and belong exclusively to XtrideLink. You shall not (a) sub license, resell, rent, lease, transfer, assign, time share or otherwise make the Service available to any third party, except as set forth in Section 12; (b) use the Service in any unlawful manner (including without limitation in violation of any data, privacy or export control laws) or in any manner that interferes with or disrupts the integrity or performance of the Service or its components or otherwise violates our acceptable use of policy (as defined below), or (c) modify, adapt or hack the Service to, or otherwise attempt to gain unauthorized access to the Service or its related systems or networks. You shall comply with any codes of conduct, policies or other notices XtrideLink provides you or publishes in connection with the Service, and you shall promptly notify XtrideLink if you learn of a security breach related to the Service. We shall not have any liability or responsibility for the actions of any third party carrier that may provide shipping services for us in connection with the Service.

4.2.By voluntarily providing us with personal information, you hereby represent that you are the owner of such personal information or are otherwise authorized to provide it to your service provider through XtrideLink platform. You further agree that you are consenting to our collection, use, storage and/or disclosure of such personal information in accordance with this Policy. You acknowledge and agree that your communications with XtrideLink will inevitably result in the transfer of information, including personal information, across international boundaries. If you provide personal information your Service provider through our Service, you acknowledge and agree that such personal information may be transferred from your current location to the offices and servers of XtrideLink and the authorized third parties referred to herein, located in Nigeria, United States of America and other countries (the Other Countries) for storage and processing in accordance with this Policy. You acknowledge and agree that the privacy and data security laws of such Other Countries may be different from the privacy and data security laws in force in the country in which you reside and agree that the privacy and security laws in effect in the applicable Other Countries may govern how your personal information may be collected, used, stored and/or disclosed.

4.3.Any software that may be made available by XtrideLink in connection with the Service, including without limitation the plug-ins, (Software) contains proprietary and confidential information that is protected by applicable intellectual property and other laws. Subject to the terms and conditions of this TOS, XtrideLink hereby grants you a non-transferable, non-sub licensable and non-exclusive right and license to use the object code of any Software solely in connection with the Service, provided that you shall not (and shall not allow any third party to) copy, modify, create a derivative work of, reverse engineer, reverse assemble or otherwise attempt to discover any source code or sell, assign, sublicense or otherwise transfer any right in any Software. You agree not to access the Service by any means other than through the interface that is provided by XtrideLink for use in accessing the Service. Any rights not expressly granted herein are reserved and no license or right to use any trademark of XtrideLink or any third party is granted to you in connection with the Service.
'''),
    Faq(
...
'''),
    Faq(
        ...
        answer:
            '''6.1.The use of the mobile Apps and Web app and the Service is free of charge according to your Service providers level of service; you will be required to provide Ship information and fund the means of payment (usually debit cards or ewallet) acceptable to XtrideLink. When you arrange for shipment, all charges for the shipment and any additional fees payable to your service provider (Charges) will be charged to the debit card, ewallet or other payment instrument associated with your account. You hereby authorize XtrideLink to bill your payment instrument for Charges in accordance with these Terms. Except as otherwise agreed by the parties, all charges, fees, or surcharges shall be those in effect at the time of shipping, available either via email, on the Site or in-apps. The applicable Charges will be based upon the characteristics of the shipment actually tendered to your service provider or rates agreed upon. If you dispute any Charges you must let XtrideLink or the Service Provider know within thirty days. XtrideLink does not have the right to add or change or adjust rates specified and agreed between customer and service provider.
...
'''),
    Faq(
        ...
        answer:
            '''8.1.If a shipment is lost or damaged while in service provider possession, you will need to contact your service provider. Your service provider may or may not provide insurance under XtrideLink platform. If your service provider has set up insurance on the platform customers shall be able to click yes or no to take extra cover. Your service providers T&Cs apply.
'''),
    Faq(
        question: '9. Referrals',
        answer:
            '''9.1.From time to time, XtrideLink platform allows service provider to add referral in app, may offer a referral program which enables you to earn credits redeemable for shipping services by sharing a unique referral link provided to you by your service provider through XtrideLink platform(Referral Link) with your friends and family
'''),
    Faq(
...
10.3.We may update the User Terms from time to time which will apply to the use of the Company site at via www.xtridelink.com  and such changes shall be binding on the User upon posting.
