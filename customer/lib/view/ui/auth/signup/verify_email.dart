...
class signUpVerifyPhonePage extends StatefulWidget {
  final VerifyType verifyType;
  const signUpVerifyPhonePage({super.key, required this.verifyType});

  @override
  State<signUpVerifyPhonePage> createState() => _VerifyMailPageState();
}

class _VerifyMailPageState extends State<signUpVerifyPhonePage> {
