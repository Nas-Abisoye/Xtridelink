...
class OngoingOrdersResModel {
  List<OrderDetails> data;

  OngoingOrdersResModel({
    required this.data,
  });

  factory OngoingOrdersResModel.fromJson(Map<String, dynamic> json) =>
      OngoingOrdersResModel(
        data: List<OrderDetails>.from((json['data']['orders'] ?? [])
