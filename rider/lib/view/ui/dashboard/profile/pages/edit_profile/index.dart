...
import 'package:xtridelink_driver/view/components/pick_date.svg.dart';
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    image = ValueNotifier(user?.profileImg);
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    HelperFunc.sb(15.h),
                    CustomPhoneInput(controller: phoneNoController),
                    HelperFunc.sb(15.h),
                    PickDateWidget(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Colors.lightBlueAccent.withOpacity(.08),
            borderRadius: BorderRadius.circular(20.r)),
        child: Row(
          children: [
            HelperFunc.sb(10.w),
            Image.asset(Assets.kyc, height: 70.h),
            HelperFunc.sb(5.w),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Manage KYC document',
                    style: AppTextStyles.mediumText(
                        fontSize: 16, color: AppColors.secColor)),
                HelperFunc.sb(3.h),
                Text('View, manage and update all your verification document ',
                    style: AppTextStyles.regularText(
                        color: AppColors.grey, fontSize: 10))
              ],
            ).EXPANDED,
            const Icon(Icons.keyboard_arrow_right, color: AppColors.secColor)
          ],
        ),
      ),
    );
