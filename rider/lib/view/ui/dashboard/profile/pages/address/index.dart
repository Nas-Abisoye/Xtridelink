...
import 'package:xtridelink_driver/view/components/search_overlay.dart';
                            ...
                            (idx) => GestureDetector(
                                  onTap: () {
                                    locationController.text =
                                        state.recentLocations[idx].address;
                                    location.value = LocationData(
                                        placeId: 'placeId',
                                        address:
                                            state.recentLocations[idx].address,
                                        latitude:
                                            state.recentLocations[idx].latitude,
                                        longitude: state
                                            .recentLocations[idx].longitude);
                                  },
                                  child: Container(
                                    padding:
